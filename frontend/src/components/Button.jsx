...
const variantClasses = {
  primary:
    'border border-violet-300/20 bg-[linear-gradient(135deg,rgba(129,140,248,1),rgba(168,85,247,0.92))] text-white shadow-[0_18px_40px_rgba(76,29,149,0.35)] hover:shadow-[0_22px_48px_rgba(76,29,149,0.45)]',
  secondary:
...
export default function Button({
  ...
  return (
    <motion.button
      ...
      aria-busy={loading}
      className={cx(
        'inline-flex items-center justify-center gap-2 font-semibold tracking-tight transition duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-300/70 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 disabled:cursor-not-allowed disabled:opacity-60',
